	...
	<TR>
		<TD>
			<DIV ID="printFormatSetting">
				...
				&nbsp;&nbsp;
				<SELECT	ID="printFitSetting" CLASS="birtviewer_printreport_dialog_select" disabled="disabled">
				...
				<TABLE>
					<TR>
						...
						<TD STYLE="padding-left:5px">
							...
							<INPUT TYPE="text" CLASS="birtviewer_printreport_dialog_input" ID="printPageRange_input" disabled="disabled"/>
						</TD>
					</TR>		
				</TABLE>
			</DIV>
