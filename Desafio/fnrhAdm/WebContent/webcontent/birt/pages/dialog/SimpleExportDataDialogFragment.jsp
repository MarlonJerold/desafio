	...
	<TR>
		<TD VALIGN="top">
			<TABLE STYLE="font-size:8pt;">
				...
				<TR><TD>
					<SELECT ID="availableColumnSelect" multiple="multiple" SIZE="10" CLASS="birtviewer_exportdata_dialog_select">
					</SELECT>
				</TD></TR>
			</TABLE>
		</TD>
		...
		<TD >
			<TABLE STYLE="font-size:8pt;">
				...
				<TR><TD>
					<SELECT ID="selectedColumnSelect" multiple="multiple" SIZE="10" CLASS="birtviewer_exportdata_dialog_select">
					</SELECT>
				</TD></TR>
			</TABLE>
		</TD>
				...
				<TABLE>
					...
					<TR>
						...
						<TD>
							...
							<INPUT TYPE="text" NAME="exportDataOtherEncoding" ID="exportDataOtherEncoding_input" CLASS="birtviewer_exportdata_dialog_input" disabled="disabled"><%= BirtResources.getMessage( "birt.viewer.dialog.exportdata.encoding.comment" )%>
						</TD>
					</TR>
				</TABLE>				
			</DIV>
