...
select res.idreservasfront
  ...
  left join cm.historicoestada he on he.idhospede = hos.idhospede and he.datachegada = mov.datachegprevista and he.idhotel = hot.idhotel
  ...
  left join cm.telendpess cel on endres.idendereco = cel.idendereco and cel.tipo='L' and cel.numero is not null
  left join cm.telendpess tel on endres.idendereco = tel.idendereco and tel.tipo='P' and tel.numero is not null
